...
public:
    ...
    void setupUi(QWidget *Form)
    {
        ...
        if (QIcon::hasThemeIcon(iconThemeName)) {
            ...
            icon.addFile(QString::fromUtf8(":/imegion/icons8-calculator-100.png"), QSize(), QIcon::Normal, QIcon::Off);
        }
...
"}"));
    ...
    {
        Form->setWindowTitle(QCoreApplication::translate("Form", "NoteS", nullptr));
